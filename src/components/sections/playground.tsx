  ...
  >
    ...
    `}</style>
      ...
      <div className="flex justify-start">
        ...
        <p className="text-[#36C5F0] font-semibold text-lg md:text-xl flex items-center">
  <img src="star.png" alt="Star" className="w-5 h-5 mr-2" />
  <span className="text-white">Experience</span>&nbsp;Workflow
</p>

          <h1 className="text-4xl md:text-6xl font-bold leading-tight">
            <span className="text-[#36C5F0]">The Ultimate Style <br /> Playground</span>
          </h1>
        </header>
      </div>
      ...
      <div className={`flex gap-6 ${isVisible? "animate-scroll" : "reset-scroll"}`}>
          ...
          <div className="flex flex-col p-3 w-[312px] bg-gradient-to-b from-[#282828] to-[#0D0D0D] rounded-2xl shadow-lg">
            ...
            <div className="text-center space-y-1.5 p-2">
              <p className="text-[18px] font-bold tracking-[1px] text-left">
                Fashion is more than just what you wear it&apos;s a statement, 
                a collection of moments, a reflection of who you are.
              </p>
              <p className="text-[#36C5F0] text-left font-bold tracking-[1px]">
                With Outfeatz, turn your best outfit shots into stunning, 
                cut-out digital galleries that let your style shine like never before.
              </p>
            </div>
        ...
        <div className="flex flex-col items-center text-center mt-35 gap-35">
          <div className="grid grid-cols-2 gap-4 bg-gradient-to-b from-[#282828] to-[#0D0D0D] rounded-2xl shadow-lg p-4">
            ...
            <h1 className="text-left text-white">After</h1>
            <div className="space-y-4">
              <Image src="/left1.jpg" alt="Before Image 1" width={119} height={92} className="w-[119px] h-[92px] object-cover rounded-2xl" />
